...
require'utlities.php';
 ...
 if (loggedIn()){
    ...
    $sql1="SELECT * FROM `teacher` WHERE `email`='$userEmail' ";
                            ...
                            <div class="panel-body table-responsive">
                                <table class="table ">
                                    ...
                                    <tr>
                                        ...
                                        <th>Gender</th>
                                        <td><b class="fa fa-mars" aria-hidden="true"></b> <?php echo ucfirst($result1['gender']); ?> </td>
                                        <td ><a class="btn btn-info edit-btn">Edit <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;<a class='btn btn-success save-btn'>Save <i class='fa fa-floppy-o' aria-hidden='true'></i></a>&nbsp;<a class='btn btn-danger cancel-btn'>Cancel <i class='fa fa-ban' aria-hidden='true'></i></a></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>CNIC</th>
                                        <td ><b> <?php echo ucfirst($result1['cnic']); ?> </b> &nbsp;</td>
                                        <td ><a class="btn btn-info edit-btn">Edit <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;<a class='btn btn-success save-btn'>Save <i class='fa fa-floppy-o' aria-hidden='true'></i></a>&nbsp;<a class='btn btn-danger cancel-btn'>Cancel <i class='fa fa-ban' aria-hidden='true'></i></a></td>
                                    </tr>
                                    <tr>
                                        <th>Phone</th>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        <td>Graduation</td>
                                        <td>Prinston University</td>
                                        <td>2000</td>
                                    </tr>
                                    <tr>
                                        <td>High School</td>
                                        <td>DPS Model Town</td>
                                        <td>1996</td>
                                    </tr>
